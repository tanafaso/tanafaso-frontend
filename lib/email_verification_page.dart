...
import 'package:azkar/login_page.dart';
...
import 'package:azkar/pin_code_text_field.dart';
                  ...
                  child: FlatButton(
                    onPressed: () async {
                      ...
                      if (currentText.length != 6) {
                        ...
                        Authentication
                            .verifyEmail(new EmailVerificationRequest(email:
                        widget.phoneNumber, pin: int.parse(currentText)))
                            .then<EmailVerificationResponse>(
                                (EmailVerificationResponse value) {
                                 if (value.hasError()) {
                                   errorController.add(ErrorAnimationType
                                       .shake); // Triggering error shake animation
                                   setState(() {
                                   ...
                                   Fluttertoast.showToast(
                                       ...
                                       backgroundColor: new Color.fromARGB(180,
                                           105, 240, 174),
                                ...
                                Navigator.push(context, MaterialPageRoute
                                  ...
                                  (firstLoginScreenToShow: LoginScreen
                                    .login)));
                                 }
                                }
                        );
