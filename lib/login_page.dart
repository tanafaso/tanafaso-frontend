// TODO: Add this license somewhere: https://github.com/samarthagarwal/FlutterScreens/blob/master/LICENSE
...
enum LoginScreen { main, login, signUp }

class LoginPage extends StatefulWidget {
  LoginScreen _firstLoginScreenToShow;

  LoginPage({LoginScreen firstLoginScreenToShow = LoginScreen.main});

  @override
  _LoginPageState createState() {
    _LoginPageState state = new _LoginPageState();
    switch (_firstLoginScreenToShow) {
...
class _LoginPageState extends State<LoginPage> with TickerProviderStateMixin {
                          ...
                          child: TextFormField(
                            ...
                            validator: (confirmedPassword) {
                              if (confirmedPassword != _password) {
                                print(confirmedPassword.length.toString() +
                                    " " +
  ...
  performSignUp() async {
    Authentication.signUp(new EmailRegistrationRequest(
        ...
        .then<EmailRegistrationResponse>((EmailRegistrationResponse value) {
      if (value.hasError()) {
        showDialog(
            context: context,
            builder: (_) => AlertDialog(
                  title: Text("Error"),
                  content: Text(value.error.error_message),
                  actions: <Widget>[
                    new FlatButton(
                      onPressed: () {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => new PinCodeVerificationScreen(_email)));
      }
    });
  }
