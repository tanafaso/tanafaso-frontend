...
class _FriendScreenState extends State<FriendScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    int friendScore = widget.userScores
        .firstWhere((userScore) => userScore.username == widget.friend.username)
        .totalScore;
    int currentUserScore = widget.userScores
        .firstWhere((userScore) => userScore.username != widget.friend.username)
        .totalScore;
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(currentUserScore.toString()),
                                  ),
                                  Icon(
                                    Icons.done_all,
                                    // color: Colors.green,
