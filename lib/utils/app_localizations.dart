...
class AppLocalizations {
  ...
  static Map<String, Map<String, String>> _localizedValues = {
    'ar': {
      ...
      'your friend can find his user code on his profile page': 'يمكن لصديقك العثور على رمز المستخدم الخاص به على صفحة ملفه الشخصي',
  ...
  String get yourFriendCanFindHisUserCodeOnHisProfilePage {
    return _localizedValues[locale.languageCode]['your friend can find his user code on his profile page'];
  }
